...
import nuvio.composeapp.generated.resources.plugins_badge_tmdb_set
import nuvio.composeapp.generated.resources.plugins_badge_tmdb_missing
import nuvio.composeapp.generated.resources.plugins_tmdb_warning
import nuvio.composeapp.generated.resources.plugins_toggle_enable_title
import nuvio.composeapp.generated.resources.plugins_toggle_enable_subtitle
import nuvio.composeapp.generated.resources.plugins_toggle_group_title
import nuvio.composeapp.generated.resources.plugins_toggle_group_subtitle
import nuvio.composeapp.generated.resources.plugins_section_add_repository
import nuvio.composeapp.generated.resources.plugins_input_placeholder_url
import nuvio.composeapp.generated.resources.plugins_button_installing
import nuvio.composeapp.generated.resources.plugins_button_install
import nuvio.composeapp.generated.resources.plugins_error_empty_url
import nuvio.composeapp.generated.resources.plugins_installed_success
...
import nuvio.composeapp.generated.resources.plugins_repo_configure_cd
import nuvio.composeapp.generated.resources.plugins_repo_refresh_cd
import nuvio.composeapp.generated.resources.plugins_repo_delete_cd
import nuvio.composeapp.generated.resources.plugins_badge_configurable
...
import nuvio.composeapp.generated.resources.plugins_scraper_no_description
import nuvio.composeapp.generated.resources.plugins_badge_disabled_by_repo
import nuvio.composeapp.generated.resources.plugins_button_testing
import nuvio.composeapp.generated.resources.plugins_button_test
import nuvio.composeapp.generated.resources.plugins_test_results_count
import nuvio.composeapp.generated.resources.plugins_test_error_default
import nuvio.composeapp.generated.resources.plugins_dialog_settings_title
import nuvio.composeapp.generated.resources.plugins_dialog_save
import nuvio.composeapp.generated.resources.plugins_dialog_cancel
import nuvio.composeapp.generated.resources.plugins_password_hide
import nuvio.composeapp.generated.resources.plugins_password_show
import nuvio.composeapp.generated.resources.plugins_fallback_repo_label
...
fun PluginsSettingsPageContent(
    ...
    val errorEmptyUrl = stringResource(Res.string.plugins_error_empty_url)
    val installedSuccessTemplate = stringResource(Res.string.plugins_installed_success)
    val testErrorDefault = stringResource(Res.string.plugins_test_error_default)
    ...
    Column(
        ...
        NuvioSurfaceCard {
            NuvioInputField(
                ...
                placeholder = stringResource(Res.string.plugins_input_placeholder_url),
            )
                    ...
                    coroutineScope.launch {
                        when (val result = PluginRepository.addRepository(requested)) {
                            is AddPluginRepositoryResult.Success -> {
                                repositoryUrl = ""
                                message = installedSuccessTemplate.format(result.repository.name)
                            }
            ...
            sortedRepos.forEach { repo ->
                NuvioSurfaceCard {
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            if (repo.settings.isNotEmpty()) {
                                NuvioIconActionButton(
                                    ...
                                    contentDescription = stringResource(Res.string.plugins_repo_configure_cd),
                    ...
                    Row(
                        ...
                        if (repo.settings.isNotEmpty()) {
                            NuvioInfoBadge(text = stringResource(Res.string.plugins_badge_configurable))
                        }
            ...
            sortedScrapers.forEach { scraper ->
                ...
                val repositoryName = repositoryNameByUrl[scraper.repositoryUrl]
                    ?: scraper.repositoryUrl.fallbackRepositoryLabel(
                        fallback = stringResource(Res.string.plugins_fallback_repo_label)
                    )
                ...
                NuvioSurfaceCard {
                            ...
                            Column(modifier = Modifier.weight(1f)) {
                                ...
                                Text(
                                    text = scraper.description.ifBlank {
                                        stringResource(Res.string.plugins_scraper_no_description)
                                    },
                                    style = MaterialTheme.typography.bodyMedium,
                                    color = MaterialTheme.colorScheme.onSurfaceVariant,
                                    maxLines = 2,
                    ...
                    Row(
                        ...
                        if (!scraper.manifestEnabled) {
                            NuvioInfoBadge(text = stringResource(Res.string.plugins_badge_disabled_by_repo))
                        }
                    }
                                    ...
                                    .onFailure { error ->
                                        testResults[scraper.id] = listOf(
                                            PluginRuntimeResult(
                                                ...
                                                name = error.message ?: testErrorDefault,
                                                url = "about:error",
                                            ),
                                        )
                                    }
...
private fun PluginConfigDialog(
    ...
    AlertDialog(
        ...
        title = {
            Text(
                text = stringResource(Res.string.plugins_dialog_settings_title, repo.name),
                style = MaterialTheme.typography.titleLarge,
                color = MaterialTheme.colorScheme.onSurface,
            )
        },
                                    ...
                                    IconButton(onClick = {
                                        ...
                                        Icon(
                                            ...
                                            contentDescription = if (isVisible)
                                                stringResource(Res.string.plugins_password_hide)
                                            else
                                                stringResource(Res.string.plugins_password_show),
                                            tint = MaterialTheme.colorScheme.onSurfaceVariant,
                                        )
                                    }
                                },
        ...
        confirmButton = {
            TextButton(onClick = { onSave(fieldValues.toMap()) }) {
                Text(
                    text = stringResource(Res.string.plugins_dialog_save),
        ...
        dismissButton = {
            TextButton(onClick = onDismiss) {
                Text(
                    text = stringResource(Res.string.plugins_dialog_cancel),
                    style = MaterialTheme.typography.labelLarge,
                    color = MaterialTheme.colorScheme.onSurfaceVariant,
                )
            }
